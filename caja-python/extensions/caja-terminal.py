...
# -*- coding: UTF-8 -*-
  ...
  #########################################################################
  ## This text come from original Github project repository, not me      ##
  #########################################################################
 ##                                                                       ##
##              ┏━┓┏━┓ ━┓┏━┓    ╺┳╸┏━╸┏━┓┏┳┓╻┏┓╻┏━┓╻                      ##
##              ┃  ┣━┫  ┃┣━┫     ┃ ┣╸ ┣┳┛┃┃┃┃┃┗┫┣━┫┃                      ##
...
"""An embedded terminal for caja"""

__version__ = "0.1"
__appname__ = "caja-term"
...
class Conf(dict):
    ...
    def __init__(self, conf_file=None):
        ...
        dict.__init__(self)
        #General
        self['general_starthidden'] = True
        self['general_showscrollbar'] = True
